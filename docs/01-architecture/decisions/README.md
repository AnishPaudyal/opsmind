...
| [ADR-0007](0007-select-phase-8-zero-cost-cloud-deployment-and-product-delivery-architecture.md) | Select Phase 8 Zero-Cost Cloud Deployment and Product-Delivery Architecture | Proposed | 2026-08-10 | #66 |
